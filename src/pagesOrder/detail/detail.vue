...
const getMemberOrderByIdDate = async () => {
  ...
  if (
    ...
    getMemberOrderLogisticByIdDate()
  }
}

onLoad(() => {
  getMemberOrderByIdDate()
})
...
const getMemberOrderLogisticByIdDate = async () => {
  ...
  <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrolltolower">
    <template v-if="order">
      ...
      <view class="shipment">
        ...
        <!-- 用户收货地址 -->
        <view class="locate">
          <view class="user"> {{ order.receiverConcact }} </view>
